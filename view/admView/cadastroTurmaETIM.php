...
$cursoEs = $rota->getParams('Curso', 'selectCurso', null, "WHERE classificacao LIKE  'Ensino Técnico Integrado ao Médio%'");
...
<form method="post">
    <div class="hero-unit">
        <div class="row-fluid">
            <div class="span6">
                <p class="text-center"> <h4>Classificação</h4> <input disabled class="input-xlarge" value="Ensino Técnico Integrado ao Médio" name="classificacao" type="text"placeholder ="ex: Ensino Regular"> </p>
            ...
            <div class="span6">
                ...
                <?php } else { ?>
                    ...
                    <select name="moduloTurma">
                        <option value="Primeiro">Primeiro ETIM</option>
                        <option value="Segundo">Segundo ETIM</option>
                        <option value="Terceiro">Terceiro ETIM</option>
                    </select>
