...
if (isset($_REQUEST['btnSalvar'])) {
    protegeAcesso::_redirect("Location: cadastroMatricula.php?codTurma={$_POST['codTurma']}&codCurso={$_GET['codCurso']}");
    exit();
}
    ...
    <div class="hero-unit">
        <div class="row-fluid">
            <div class="span6">
                ...
                <!--Botoes do Form-->
                <br>
                <input class="btn-warning btn-small" type="button" value="Escolher Outro Curso"  onclick="window.location = 'preCadastroMatriculaCurso.php'">
            </div>
            <div class="span6">
                <p class="text-center">
