...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <div class="page-header">
                    <div class="alert alert-danger">
                        <h1>Ops !</h1>Ocorreu um erro inesperado.
                    </div>
                </div>
                <p class="lead">Desculpe, mas parece que ocorreu um evento inesperado em nosso sistema.</p>
                <p>Volte <a href="home.php">do inicio </a> e tente esta ação mais tarde.</p>
        ...
        <script type="text/javascript" src="../../estilo/dist/jquery.validate.js" ></script>
