...
if (isset($_REQUEST['btnSalvar'])) {
    protegeAcesso::_redirect("Location: preRelatorioMateriaTurmaTurma.php?codCurso={$_POST['curso']}");
}
            ...
            <div class="span6">
                ...
                <select name="curso"> 
                    <?php foreach ($curso as $c => $valor) { ?>
                        <option value="<?php echo $valor['codCurso'] ?>"><?php echo $valor['nomeCurso'] ?></option>
                    <?php } ?>
                </select>
