...
if (!isset($_SESSION['desc']) or $_SESSION['desc'] != 'Funcionario') {
    $rota->setParams('Index', 'logout');
}

$adm = $rota->getParams('Funcionario', 'selectFunc', null, "where loginFunc='{$_SESSION['login']}' and senhaFunc='{$_SESSION['senha']}'");
?>
<html lang="pt">
    <head>
        <meta charset="utf-8">
            ...
            <tr>
                ...
                <td style="padding-left: 250px; float: right">
                    <form method="post">
                        ...
                        <button name="btnEditar" type="submit" class="btn btn-primary"> Perfil de <?php echo $adm[0]['nomeFunc'] ?></button>
