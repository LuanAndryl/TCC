...
if (!isset($_SESSION['desc']) or $_SESSION['desc'] != 'Professor') {
    $rota->setParams('Index', 'logout');
}

$prof = $rota->getParams('Professor', 'selectProfActive', null, "loginProf='{$_SESSION['login']}' and senhaProf='{$_SESSION['senha']}'");
?>
<html lang="pt">
    <head>
        <meta charset="utf-8">
    ...
    <div class="logo">
        ...
        <table>
            <tr>
                ...
                <td>
                    <form method="post">
                        <span class="label label label-info"> Bem vindo  <?php echo $_SESSION['desc'] . "(a)" ?></span>
                        <button name="btnEditar" type="submit" class="btn btn-primary"> Perfil de <?php echo $prof[0]['nomeProf'] ?></button>
                        <input name="btnSair" type="submit" value="Sair" class="btn btn-danger">
                        <img width="128" height="128" src="../../img/user-icons/prof2.png" />
                    </form>
                </td>
            <tr>
        </table>
                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        <ul class="nav">
                            ...
                            <li><a href="preChamadaMateria.php?codProf=<?php echo $prof[0]['codProf'] ?>">Chamada</a></li>
                            <!-- Objeto 5 -->
                            <li><a href="preAulasDadas.php">Aulas Dadas</a></li>
                        </ul>
                        <!-- Fechando barra -->
                    </div>
                </div>
