        ...
        <div class="container">
            ...
            <div class="jumbotron masthead">
                ...
                <div class="form  form-actions" >
                    <strong> SOGFe </strong>- Sistema Online de Gerenciamento de Frequencia Escolar
                </div>
                <div class="progress progress-striped active">
                    <div class="bar" style="width: 2%;"></div>
                </div>
                <p class="lead">Me parece que o sistema ainda não esta configurado ainda clique no botão abaixo para começar a configuração.</p>
                <a class="btn btn-large btn-success" href="passo1.php">Configurar</a>
            </div>
